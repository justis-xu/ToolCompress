...
| 场景 | 策略 | 压缩前 tokens | 压缩后 tokens | 减少比例 | p50 | p95 | QPS |
|---|---|---:|---:|---:|---:|---:|---:|
| JSON-100 | smart_crusher | 1,000 | 511 | 51.1% | 99.5ms | 138.2ms | 79.2/s |
| JSON-500 | smart_crusher | 5,000 | 2,511 | 50.2% | 166.1ms | 250.4ms | 46.6/s |
| JSON-1000 | smart_crusher | 10,000 | 5,011 | 50.1% | 257.1ms | 377.4ms | 30.1/s |
| 日志-500 | log | 4,500 | 618 | 13.7% | 123.2ms | 204.0ms | 63.6/s |
| 日志-1000 | log | 9,000 | 618 | 6.9% | 150.2ms | 244.5ms | 51.8/s |
| 日志-2000 | log | 18,000 | 618 | 3.4% | 209.3ms | 307.2ms | 37.2/s |
| 搜索-200 | search | 880 | 190 | 21.6% | 102.3ms | 138.8ms | 77.4/s |
| 搜索-1000 | search | 4,400 | 190 | 4.3% | 141.8ms | 211.5ms | 54.7/s |
| 代码-200 | code_aware | 2,110 | 740 | 35.1% | 214.3ms | 455.2ms | 29.8/s |
| 代码-1000 | code_aware | 9,810 | 3,380 | 34.4% | 673.8ms | 1,091.3ms | 10.7/s |
| 图片 1536x1024 | image/jpeg | 680 | 255 | 37.5% | 178.4ms | 192.6ms | 63.1/s |
| Batch 8xJSON-100 | batch | 8,000 | 4,088 | 51.1% | 947.7ms | 1,089.3ms | 10.2/s |
| Diff-30hunks | diff | 802 | 554 | 69.1% | 92.0ms | 133.7ms | 87.3/s |
| Diff-100hunks | diff | 2,655 | 1,358 | 51.1% | 96.1ms | 145.0ms | 81.9/s |
...
| 场景 | 压缩策略 | 数据集/Payload | n | 压缩前 token | 压缩后 token | 减少比例 | 压缩后准确率 |
|---|---|---|---:|---:|---:|---:|---|
